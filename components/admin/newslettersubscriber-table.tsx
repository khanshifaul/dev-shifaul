"use client";
import { DELETE_NEWSLETTER_SUBSCRIBER } from "@/app/api/graphql/mutations";
import { GET_NEWSLETTER_SUBSCRIBERS } from "@/app/api/graphql/queries";
import {
  Table,
  TableBody,
  TableCell,
...
import { INewsletterSubscriber } from "@/types/globals";
...
const NewsletterSubscriberTable = () => {
  ...
  const { loading, error, data } = useQuery(GET_NEWSLETTER_SUBSCRIBERS);
